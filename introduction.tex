...
\ewu{That's fair, will need to address why a framework is necessary (I think a framework is the correct pitch, hard to sell a set of operators).  Are the above chalenges -- extensibility and scalability -- actually difficult?  Worried it's straightforward application of existing techniques.}
