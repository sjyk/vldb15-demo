...
\ewu{add a point about optimization}

% move sanjay's stuff to beginning of research challenges
% sanjay addes couple words about correctness of hot swapping
% jn cuts sample-and-clean
% dan/sanjay look over contributions in intro


% wrangler: helps construct data pipeline
%           doesn't optimize in a task psecific way, 
%           is'nt general data pipeline
