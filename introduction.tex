...
data cleaning framework as part of the modern big data ecosystems. \ewu{include open access of data in argument?}
...
similar or duplicate records. \ewu{quickly validate why this observation holds.}   
