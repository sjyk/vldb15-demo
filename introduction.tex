...
Data analysis is inherently iterative and Figure~\ref{fig:ex-plan} shows a common progression for the development of a data cleaning operator, in this case the extraction of a restaurant's address from its unstructured webpage.
